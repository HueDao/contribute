...
<body>
  ...
  <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <li class="active"><a href="{{ url("/list_order_delivery")}}">Đơn giao hàng</a></li>
        </ul>
      </div>
    </nav>
        ...
        @if(isset($orders) && !empty($orders))
          @foreach ($orders as $order)
            <tr>
              ...
              <td>
                <a href="{{url("/store/order_detail_delivery/$order->id")}}" class="btn btn-warning">Xem chi tiết đơn hàng giao</a>
              </td>
            </tr>
          @endforeach
        @else
