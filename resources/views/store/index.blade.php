...
<body>
  ...
  <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <li class="active"><a href="{{ url("/order/index")}}">Tạo đơn lấy hàng</a></li>
    ...
    <h2>Danh sách các sản phẩm chờ lấy hàng</h2>
    ...
    @endif
    <form name="delete_register_category" action="{{ url("/create_order/1")}}" method="post">
    @csrf
